# examples-api-expansion - Task 22

Execute task 22 for the examples-api-expansion specification.

## Task Description
Add Unix shell execution scripts
...
## Usage
```
/Task:22-examples-api-expansion
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add Unix shell execution scripts"

```
Use the @spec-task-executor agent to implement task 22: "Add Unix shell execution scripts" for the examples-api-expansion specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Add Unix shell execution scripts
- Requirements: 7.4, 7.5

## Instructions
- Implement ONLY task 22: "Add Unix shell execution scripts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks examples-api-expansion 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks examples-api-expansion 22 --mode complete
```
