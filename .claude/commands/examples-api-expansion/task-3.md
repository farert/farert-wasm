# examples-api-expansion - Task 3

Execute task 3 for the examples-api-expansion specification.

## Task Description
Create line operations example with complete API coverage
...
## Usage
```
/Task:3-examples-api-expansion
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create line operations example with complete API coverage"

```
Use the @spec-task-executor agent to implement task 3: "Create line operations example with complete API coverage" for the examples-api-expansion specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create line operations example with complete API coverage
- Leverage: examples/api/railway
- Requirements: 1.2, 1.3

## Instructions
- Implement ONLY task 3: "Create line operations example with complete API coverage"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks examples-api-expansion 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks examples-api-expansion 3 --mode complete
```
