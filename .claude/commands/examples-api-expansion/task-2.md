# examples-api-expansion - Task 2

Execute task 2 for the examples-api-expansion specification.

## Task Description
Create station lookup example with comprehensive API demonstrations

## Code Reuse
**Leverage existing code**: examples/api/railway
...
## Usage
```
/Task:2-examples-api-expansion
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create station lookup example with comprehensive API demonstrations"

```
Use the @spec-task-executor agent to implement task 2: "Create station lookup example with comprehensive API demonstrations" for the examples-api-expansion specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Create station lookup example with comprehensive API demonstrations
- Leverage: examples/api/railway
- Requirements: 1.1, 1.2

## Instructions
- Implement ONLY task 2: "Create station lookup example with comprehensive API demonstrations"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks examples-api-expansion 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks examples-api-expansion 2 --mode complete
```
