# examples-api-expansion - Task 6

Execute task 6 for the examples-api-expansion specification.

## Task Description
Create comprehensive TypeScript integration example

## Code Reuse
**Leverage existing code**: src/sdk/types/core.ts, src/sdk/core/wasm-wrapper.ts
...
## Usage
```
/Task:6-examples-api-expansion
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create comprehensive TypeScript integration example"

```
Use the @spec-task-executor agent to implement task 6: "Create comprehensive TypeScript integration example" for the examples-api-expansion specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Create comprehensive TypeScript integration example
- Leverage: src/sdk/types/core.ts, src/sdk/core/wasm-wrapper.ts
- Requirements: 2.1, 2.2, 2.3

## Instructions
- Implement ONLY task 6: "Create comprehensive TypeScript integration example"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks examples-api-expansion 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks examples-api-expansion 6 --mode complete
```
