# examples-api-expansion - Task 12

Execute task 12 for the examples-api-expansion specification.

## Task Description
Create performance optimization example with benchmarking

## Code Reuse
**Leverage existing code**: src/sdk/core/memory-manager.ts, src/sdk/cache/lru-cache.ts
...
## Usage
```
/Task:12-examples-api-expansion
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create performance optimization example with benchmarking"

```
Use the @spec-task-executor agent to implement task 12: "Create performance optimization example with benchmarking" for the examples-api-expansion specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Create performance optimization example with benchmarking
- Leverage: src/sdk/core/memory-manager.ts, src/sdk/cache/lru-cache.ts
- Requirements: 4.1, 4.2, 4.3, 4.4, 4.5

## Instructions
- Implement ONLY task 12: "Create performance optimization example with benchmarking"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks examples-api-expansion 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks examples-api-expansion 12 --mode complete
```
