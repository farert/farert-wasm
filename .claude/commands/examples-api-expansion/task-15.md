# examples-api-expansion - Task 15

Execute task 15 for the examples-api-expansion specification.

## Task Description
Create advanced patterns directory
...
## Usage
```
/Task:15-examples-api-expansion
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create advanced patterns directory"

```
Use the @spec-task-executor agent to implement task 15: "Create advanced patterns directory" for the examples-api-expansion specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Create advanced patterns directory
- Requirements: 6.1

## Instructions
- Implement ONLY task 15: "Create advanced patterns directory"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks examples-api-expansion 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks examples-api-expansion 15 --mode complete
```
