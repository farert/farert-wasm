# examples-api-expansion - Task 16

Execute task 16 for the examples-api-expansion specification.

## Task Description
Create advanced integration patterns example

## Code Reuse
**Leverage existing code**: src/sdk/core/farert-sdk.ts, src/sdk/cache/cache-manager.ts
...
## Usage
```
/Task:16-examples-api-expansion
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create advanced integration patterns example"

```
Use the @spec-task-executor agent to implement task 16: "Create advanced integration patterns example" for the examples-api-expansion specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: Create advanced integration patterns example
- Leverage: src/sdk/core/farert-sdk.ts, src/sdk/cache/cache-manager.ts
- Requirements: 6.1, 6.2, 6.3, 6.4, 6.5

## Instructions
- Implement ONLY task 16: "Create advanced integration patterns example"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks examples-api-expansion 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks examples-api-expansion 16 --mode complete
```
