# wasm-object-classes - Task 22

Execute task 22 for the wasm-object-classes specification.

## Task Description
Create Android compatibility validation in src/cli/android_compat.ts

## Code Reuse
**Leverage existing code**: existing FareInfoData interface structure
...
## Usage
```
/Task:22-wasm-object-classes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Android compatibility validation in src/cli/android_compat.ts"

```
Use the @spec-task-executor agent to implement task 22: "Create Android compatibility validation in src/cli/android_compat.ts" for the wasm-object-classes specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create Android compatibility validation in src/cli/android_compat.ts
- Leverage: existing FareInfoData interface structure
- Requirements: REQ-OBJ-005

## Instructions
- Implement ONLY task 22: "Create Android compatibility validation in src/cli/android_compat.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks wasm-object-classes 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks wasm-object-classes 22 --mode complete
```
