# wasm-object-classes - Task 23

Execute task 23 for the wasm-object-classes specification.

## Task Description
Add Android-compatible method signatures in src/cli/types.ts

## Code Reuse
**Leverage existing code**: existing FareInfoData and RouteWrapper interfaces
...
## Usage
```
/Task:23-wasm-object-classes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add Android-compatible method signatures in src/cli/types.ts"

```
Use the @spec-task-executor agent to implement task 23: "Add Android-compatible method signatures in src/cli/types.ts" for the wasm-object-classes specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Add Android-compatible method signatures in src/cli/types.ts
- Leverage: existing FareInfoData and RouteWrapper interfaces
- Requirements: REQ-OBJ-005

## Instructions
- Implement ONLY task 23: "Add Android-compatible method signatures in src/cli/types.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks wasm-object-classes 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks wasm-object-classes 23 --mode complete
```
