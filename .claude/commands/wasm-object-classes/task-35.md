# wasm-object-classes - Task 35

Execute task 35 for the wasm-object-classes specification.

## Task Description
Create object class usage examples in src/cli/examples/

## Code Reuse
**Leverage existing code**: existing CLI patterns in main.ts
...
## Usage
```
/Task:35-wasm-object-classes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create object class usage examples in src/cli/examples/"

```
Use the @spec-task-executor agent to implement task 35: "Create object class usage examples in src/cli/examples/" for the wasm-object-classes specification and include all the below context.
...
## Task Details
- Task ID: 35
- Description: Create object class usage examples in src/cli/examples/
- Leverage: existing CLI patterns in main.ts
- Requirements: REQ-OBJ-008

## Instructions
- Implement ONLY task 35: "Create object class usage examples in src/cli/examples/"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks wasm-object-classes 35 --mode complete
...
```bash
claude-code-spec-workflow get-tasks wasm-object-classes 35 --mode complete
```
