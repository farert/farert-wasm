# wasm-object-classes - Task 10

Execute task 10 for the wasm-object-classes specification.

## Task Description
Add cRouteItem WebAssembly bindings in src/farert_wasm.cpp

## Code Reuse
**Leverage existing code**: existing FareInfoData bindings pattern lines 584-611
...
## Usage
```
/Task:10-wasm-object-classes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add cRouteItem WebAssembly bindings in src/farert_wasm.cpp"

```
Use the @spec-task-executor agent to implement task 10: "Add cRouteItem WebAssembly bindings in src/farert_wasm.cpp" for the wasm-object-classes specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Add cRouteItem WebAssembly bindings in src/farert_wasm.cpp
- Leverage: existing FareInfoData bindings pattern lines 584-611
- Requirements: REQ-OBJ-003

## Instructions
- Implement ONLY task 10: "Add cRouteItem WebAssembly bindings in src/farert_wasm.cpp"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks wasm-object-classes 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks wasm-object-classes 10 --mode complete
```
