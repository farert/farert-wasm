# wasm-object-classes - Task 32

Execute task 32 for the wasm-object-classes specification.

## Task Description
Create Android compatibility tests in src/cli/test_android_compat.ts

## Code Reuse
**Leverage existing code**: android
...
## Usage
```
/Task:32-wasm-object-classes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Android compatibility tests in src/cli/test_android_compat.ts"

```
Use the @spec-task-executor agent to implement task 32: "Create Android compatibility tests in src/cli/test_android_compat.ts" for the wasm-object-classes specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Create Android compatibility tests in src/cli/test_android_compat.ts
- Leverage: android
- Requirements: REQ-OBJ-005

## Instructions
- Implement ONLY task 32: "Create Android compatibility tests in src/cli/test_android_compat.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks wasm-object-classes 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks wasm-object-classes 32 --mode complete
```
