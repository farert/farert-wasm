# flutter-plugin - Task 10

Execute task 10 for the flutter-plugin specification.

## Task Description
Create LineInfo model in lib/src/models/line_info.dart

## Code Reuse
**Leverage existing code**: src/sdk/types/line.ts
...
## Usage
```
/Task:10-flutter-plugin
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create LineInfo model in lib/src/models/line_info.dart"

```
Use the @spec-task-executor agent to implement task 10: "Create LineInfo model in lib/src/models/line_info.dart" for the flutter-plugin specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create LineInfo model in lib/src/models/line_info.dart
- Leverage: src/sdk/types/line.ts
- Requirements: 2.3, 3.7

## Instructions
- Implement ONLY task 10: "Create LineInfo model in lib/src/models/line_info.dart"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks flutter-plugin 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks flutter-plugin 10 --mode complete
```
