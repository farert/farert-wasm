# flutter-plugin - Task 7

Execute task 7 for the flutter-plugin specification.

## Task Description
Create StationInfo model in lib/src/models/station_info.dart

## Code Reuse
**Leverage existing code**: src/sdk/types/station.ts
...
## Usage
```
/Task:7-flutter-plugin
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create StationInfo model in lib/src/models/station_info.dart"

```
Use the @spec-task-executor agent to implement task 7: "Create StationInfo model in lib/src/models/station_info.dart" for the flutter-plugin specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create StationInfo model in lib/src/models/station_info.dart
- Leverage: src/sdk/types/station.ts
- Requirements: 2.3, 3.7

## Instructions
- Implement ONLY task 7: "Create StationInfo model in lib/src/models/station_info.dart"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks flutter-plugin 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks flutter-plugin 7 --mode complete
```
