# flutter-plugin - Task 40

Execute task 40 for the flutter-plugin specification.

## Task Description
Create example Flutter app in example/lib/main.dart

## Code Reuse
**Leverage existing code**: all implemented widgets and APIs
...
## Usage
```
/Task:40-flutter-plugin
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create example Flutter app in example/lib/main.dart"

```
Use the @spec-task-executor agent to implement task 40: "Create example Flutter app in example/lib/main.dart" for the flutter-plugin specification and include all the below context.
...
## Task Details
- Task ID: 40
- Description: Create example Flutter app in example/lib/main.dart
- Leverage: all implemented widgets and APIs
- Requirements: 7.2, 7.5

## Instructions
- Implement ONLY task 40: "Create example Flutter app in example/lib/main.dart"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks flutter-plugin 40 --mode complete
...
```bash
claude-code-spec-workflow get-tasks flutter-plugin 40 --mode complete
```
