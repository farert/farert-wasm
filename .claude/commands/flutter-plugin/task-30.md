# flutter-plugin - Task 30

Execute task 30 for the flutter-plugin specification.

## Task Description
Create test utilities in test/utils/test_utils.dart
...
## Usage
```
/Task:30-flutter-plugin
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create test utilities in test/utils/test_utils.dart"

```
Use the @spec-task-executor agent to implement task 30: "Create test utilities in test/utils/test_utils.dart" for the flutter-plugin specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Create test utilities in test/utils/test_utils.dart
- Leverage: src/cli/test
- Requirements: 8.1, 8.6

## Instructions
- Implement ONLY task 30: "Create test utilities in test/utils/test_utils.dart"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks flutter-plugin 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks flutter-plugin 30 --mode complete
```
