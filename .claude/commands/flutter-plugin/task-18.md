# flutter-plugin - Task 18

Execute task 18 for the flutter-plugin specification.

## Task Description
Add station and line utility methods to farert_api.dart
...
## Usage
```
/Task:18-flutter-plugin
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add station and line utility methods to farert_api.dart"

```
Use the @spec-task-executor agent to implement task 18: "Add station and line utility methods to farert_api.dart" for the flutter-plugin specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Add station and line utility methods to farert_api.dart
- Leverage: src/core/route
- Requirements: 2.1, 2.3

## Instructions
- Implement ONLY task 18: "Add station and line utility methods to farert_api.dart"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks flutter-plugin 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks flutter-plugin 18 --mode complete
```
