...
## Task Description
Create Svelte stores in src/sdk/svelte/stores.ts

## Code Reuse
**Leverage existing code**: src/sdk/utils/station-utils.ts, src/sdk/utils/route-utils.ts
...
Execute with @spec-task-executor agent the following task: "Create Svelte stores in src/sdk/svelte/stores.ts"

```
Use the @spec-task-executor agent to implement task 13: "Create Svelte stores in src/sdk/svelte/stores.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: Create Svelte stores in src/sdk/svelte/stores.ts
- Leverage: src/sdk/utils/station-utils.ts, src/sdk/utils/route-utils.ts
- Requirements: REQ-API-003

## Instructions
- Implement ONLY task 13: "Create Svelte stores in src/sdk/svelte/stores.ts"
