...
Execute task 10 for the frontend-api-layer specification.

## Task Description
Create route building utilities in src/sdk/utils/route-utils.ts

## Code Reuse
**Leverage existing code**: src/sdk/core/object-classes.ts cRoute wrappers
...
Execute with @spec-task-executor agent the following task: "Create route building utilities in src/sdk/utils/route-utils.ts"

```
Use the @spec-task-executor agent to implement task 10: "Create route building utilities in src/sdk/utils/route-utils.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create route building utilities in src/sdk/utils/route-utils.ts
- Leverage: src/sdk/core/object-classes.ts cRoute wrappers
- Requirements: REQ-API-005

## Instructions
- Implement ONLY task 10: "Create route building utilities in src/sdk/utils/route-utils.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 10 --mode complete
```
