# frontend-api-layer - Task 32

Execute task 32 for the frontend-api-layer specification.

## Task Description
Create cross-framework compatibility tests in tests/sdk/compatibility/cross-framework.test.ts

## Code Reuse
**Leverage existing code**: all framework integration layers
...
## Usage
```
/Task:32-frontend-api-layer
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create cross-framework compatibility tests in tests/sdk/compatibility/cross-framework.test.ts"

```
Use the @spec-task-executor agent to implement task 32: "Create cross-framework compatibility tests in tests/sdk/compatibility/cross-framework.test.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Create cross-framework compatibility tests in tests/sdk/compatibility/cross-framework.test.ts
- Leverage: all framework integration layers
- Requirements: REQ-API-005

## Instructions
- Implement ONLY task 32: "Create cross-framework compatibility tests in tests/sdk/compatibility/cross-framework.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 32 --mode complete
```
