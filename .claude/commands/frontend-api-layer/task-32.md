...
```
Use the @spec-task-executor agent to implement task 32: "Create performance benchmark tests in tests/sdk/performance/benchmarks.test.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 32: "Create performance benchmark tests in tests/sdk/performance/benchmarks.test.ts"
