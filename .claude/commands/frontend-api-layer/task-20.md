...
## Task Description
Create framework detection utility in src/sdk/utils/framework-detector.ts

## Code Reuse
**Leverage existing code**: dynamic import patterns
...
Execute with @spec-task-executor agent the following task: "Create framework detection utility in src/sdk/utils/framework-detector.ts"

```
Use the @spec-task-executor agent to implement task 20: "Create framework detection utility in src/sdk/utils/framework-detector.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create framework detection utility in src/sdk/utils/framework-detector.ts
- Leverage: dynamic import patterns
- Requirements: REQ-API-005

## Instructions
- Implement ONLY task 20: "Create framework detection utility in src/sdk/utils/framework-detector.ts"
