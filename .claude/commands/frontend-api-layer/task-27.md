# frontend-api-layer - Task 27

Execute task 27 for the frontend-api-layer specification.
...
```
Use the @spec-task-executor agent to implement task 27: "Create debugging utilities in src/sdk/debug/debug-tools.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 27: "Create debugging utilities in src/sdk/debug/debug-tools.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 27 --mode complete
```
