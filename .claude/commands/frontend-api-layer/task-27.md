...
```
Use the @spec-task-executor agent to implement task 27: "Create main SDK export in src/sdk/index.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 27: "Create main SDK export in src/sdk/index.ts"
