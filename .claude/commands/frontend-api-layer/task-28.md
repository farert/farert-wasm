...
## Task Description
Create debugging utilities in src/sdk/debug/debug-tools.ts
...
Execute with @spec-task-executor agent the following task: "Create debugging utilities in src/sdk/debug/debug-tools.ts"

```
Use the @spec-task-executor agent to implement task 28: "Create debugging utilities in src/sdk/debug/debug-tools.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: Create debugging utilities in src/sdk/debug/debug-tools.ts
- Leverage: src/sdk/cache/cache-manager.ts
- Requirements: REQ-API-006

## Instructions
- Implement ONLY task 28: "Create debugging utilities in src/sdk/debug/debug-tools.ts"
