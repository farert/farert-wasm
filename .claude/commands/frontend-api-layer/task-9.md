...
Execute task 9 for the frontend-api-layer specification.

## Task Description
Create station utilities in src/sdk/utils/station-utils.ts

## Code Reuse
**Leverage existing code**: src/sdk/core/farert-sdk.ts station APIs
...
Execute with @spec-task-executor agent the following task: "Create station utilities in src/sdk/utils/station-utils.ts"

```
Use the @spec-task-executor agent to implement task 9: "Create station utilities in src/sdk/utils/station-utils.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 9
- Description: Create station utilities in src/sdk/utils/station-utils.ts
- Leverage: src/sdk/core/farert-sdk.ts station APIs
- Requirements: REQ-API-005

## Instructions
- Implement ONLY task 9: "Create station utilities in src/sdk/utils/station-utils.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 9 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 9 --mode complete
```
