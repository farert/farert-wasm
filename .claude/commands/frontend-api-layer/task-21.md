# frontend-api-layer - Task 21

Execute task 21 for the frontend-api-layer specification.
...
```
Use the @spec-task-executor agent to implement task 21: "Create bundle analyzer configuration in src/sdk/build/bundle-analyzer.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 21: "Create bundle analyzer configuration in src/sdk/build/bundle-analyzer.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 21 --mode complete
```
