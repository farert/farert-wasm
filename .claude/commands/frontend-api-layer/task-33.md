...
## Task Description
Create React example application in examples/react-example/

## Code Reuse
**Leverage existing code**: src/sdk/react/ hooks and components
...
Execute with @spec-task-executor agent the following task: "Create React example application in examples/react-example/"

```
Use the @spec-task-executor agent to implement task 33: "Create React example application in examples/react-example/" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Create React example application in examples/react-example/
- Leverage: src/sdk/react/ hooks and components
- Requirements: REQ-API-006

## Instructions
- Implement ONLY task 33: "Create React example application in examples/react-example/"
