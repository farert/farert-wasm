# frontend-api-layer - Task 1

Execute task 1 for the frontend-api-layer specification.

## Task Description
Create base SDK interfaces in src/sdk/types/core.ts

## Code Reuse
**Leverage existing code**: src/cli/types.ts, src/cli/wasm
...
## Usage
```
/Task:1-frontend-api-layer
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create base SDK interfaces in src/sdk/types/core.ts"

```
Use the @spec-task-executor agent to implement task 1: "Create base SDK interfaces in src/sdk/types/core.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: Create base SDK interfaces in src/sdk/types/core.ts
- Leverage: src/cli/types.ts, src/cli/wasm
- Requirements: REQ-API-001

## Instructions
- Implement ONLY task 1: "Create base SDK interfaces in src/sdk/types/core.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 1 --mode complete
```
