...
```
Use the @spec-task-executor agent to implement task 38: "Create production build configuration in build/sdk-build.js" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 38: "Create production build configuration in build/sdk-build.js"
