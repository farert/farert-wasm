...
```
Use the @spec-task-executor agent to implement task 35: "Create API documentation in docs/api-reference.md" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 35: "Create API documentation in docs/api-reference.md"
