...
## Task Description
Create main SDK export in src/sdk/index.ts

## Code Reuse
**Leverage existing code**: all implementation files from previous tasks
...
Execute with @spec-task-executor agent the following task: "Create main SDK export in src/sdk/index.ts"

```
Use the @spec-task-executor agent to implement task 26: "Create main SDK export in src/sdk/index.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Create main SDK export in src/sdk/index.ts
- Leverage: all implementation files from previous tasks
- Requirements: REQ-API-006

## Instructions
- Implement ONLY task 26: "Create main SDK export in src/sdk/index.ts"
