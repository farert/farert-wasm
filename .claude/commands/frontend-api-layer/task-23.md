...
## Task Description
Create bundle analyzer configuration in src/sdk/build/bundle-analyzer.ts

## Code Reuse
**Leverage existing code**: webpack bundle analyzer patterns
...
Execute with @spec-task-executor agent the following task: "Create bundle analyzer configuration in src/sdk/build/bundle-analyzer.ts"

```
Use the @spec-task-executor agent to implement task 23: "Create bundle analyzer configuration in src/sdk/build/bundle-analyzer.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create bundle analyzer configuration in src/sdk/build/bundle-analyzer.ts
- Leverage: webpack bundle analyzer patterns
- Requirements: Performance requirements

## Instructions
- Implement ONLY task 23: "Create bundle analyzer configuration in src/sdk/build/bundle-analyzer.ts"
