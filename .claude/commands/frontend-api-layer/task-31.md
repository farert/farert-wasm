# frontend-api-layer - Task 31

Execute task 31 for the frontend-api-layer specification.
...
```
Use the @spec-task-executor agent to implement task 31: "Create cross-framework compatibility tests in tests/sdk/compatibility/cross-framework.test.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 31: "Create cross-framework compatibility tests in tests/sdk/compatibility/cross-framework.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 31 --mode complete
```
