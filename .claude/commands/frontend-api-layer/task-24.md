...
```
Use the @spec-task-executor agent to implement task 24: "Create lazy loading utilities in src/sdk/core/lazy-loader.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 24: "Create lazy loading utilities in src/sdk/core/lazy-loader.ts"
