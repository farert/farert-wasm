# frontend-api-layer - Task 36

Execute task 36 for the frontend-api-layer specification.
...
```
Use the @spec-task-executor agent to implement task 36: "Create security validation in src/sdk/security/input-validator.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 36: "Create security validation in src/sdk/security/input-validator.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 36 --mode complete
```
