...
Execute task 5 for the frontend-api-layer specification.

## Task Description
Create WebAssembly API wrapper in src/sdk/core/wasm-wrapper.ts

## Code Reuse
**Leverage existing code**: src/cli/wasm
...
Execute with @spec-task-executor agent the following task: "Create WebAssembly API wrapper in src/sdk/core/wasm-wrapper.ts"

```
Use the @spec-task-executor agent to implement task 5: "Create WebAssembly API wrapper in src/sdk/core/wasm-wrapper.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: Create WebAssembly API wrapper in src/sdk/core/wasm-wrapper.ts
- Leverage: src/cli/wasm
- Requirements: REQ-API-001

## Instructions
- Implement ONLY task 5: "Create WebAssembly API wrapper in src/sdk/core/wasm-wrapper.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 5 --mode complete
```
