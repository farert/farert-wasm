...
## Task Description
Create Svelte SDK context in src/sdk/svelte/context.ts
...
Execute with @spec-task-executor agent the following task: "Create Svelte SDK context in src/sdk/svelte/context.ts"

```
Use the @spec-task-executor agent to implement task 12: "Create Svelte SDK context in src/sdk/svelte/context.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Create Svelte SDK context in src/sdk/svelte/context.ts
- Leverage: src/sdk/core/farert-sdk.ts
- Requirements: REQ-API-003

## Instructions
- Implement ONLY task 12: "Create Svelte SDK context in src/sdk/svelte/context.ts"
