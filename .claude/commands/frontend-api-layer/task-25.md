# frontend-api-layer - Task 25

Execute task 25 for the frontend-api-layer specification.

## Task Description
Create SvelteKit middleware in src/sdk/sveltekit/middleware.ts
...
## Usage
```
/Task:25-frontend-api-layer
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create SvelteKit middleware in src/sdk/sveltekit/middleware.ts"

```
Use the @spec-task-executor agent to implement task 25: "Create SvelteKit middleware in src/sdk/sveltekit/middleware.ts" for the frontend-api-layer specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create SvelteKit middleware in src/sdk/sveltekit/middleware.ts
- Leverage: src/sdk/core/farert-sdk.ts
- Requirements: REQ-API-004

## Instructions
- Implement ONLY task 25: "Create SvelteKit middleware in src/sdk/sveltekit/middleware.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-api-layer 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-api-layer 25 --mode complete
```
