...
```
Use the @spec-task-executor agent to implement task 25: "Create TypeScript declaration file in src/sdk/index.d.ts" for the frontend-api-layer specification and include all the below context.
...
## Instructions
- Implement ONLY task 25: "Create TypeScript declaration file in src/sdk/index.d.ts"
